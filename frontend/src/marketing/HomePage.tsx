...
const MODULES = [
  ...
  { key: "schedules", name: "Schedules", tagline: "Amortize on autopilot.", desc: "Prepaids, accruals, fixed assets, leases, and loans — amortized on schedule and surfaced as one-click suggestions in the right reconciliation.", bullets: ["Prepaids, accruals, FA, leases, loans", "Auto-amortization each period", "One-click suggestions in reconciliations", "Renewal & reversal alerts"], visual: <MiniPanel title="Amortization · this period" rows={[["Prepaid insurance — 12 mo", "$2,000"], ["Software prepaid — 24 mo", "$1,250"], ["Office lease — ROU amort.", "$8,400"]]} /> },
]
