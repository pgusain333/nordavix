...
from modules.cost_allocation.setup_router import router as cost_allocation_setup_router
...
app.include_router(cost_allocation_setup_router, prefix="/api/allocation", tags=["allocation-setup"])
